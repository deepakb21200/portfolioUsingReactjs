...
//         <div className="p-[2px] md:rounded-full md:bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-400">
...
function Header() {
  ...
  return (
    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-gray-900/95 backdrop-blur-md md:bg-transparent md:backdrop-blur-none">
      <div className="deep md:fixed md:top-4 md:left-1/2 md:transform md:-translate-x-1/2 w-full md:w-auto">
        <div className="p-[2px] md:rounded-full md:bg-gradient-to-r from-emerald-400 via-cyan-500 to-indigo-500
         animate-gradient-x">
